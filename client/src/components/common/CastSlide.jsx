...
const CastSlide = ({ casts }) => {
  return (
    <Box sx={{
      "& .swiper-slide": {
        width: { xs: "50%", md: "25%", lg: "15.5%" },
        color: "primary.contrastText",
        borderRadius: "70px 70px 0 0", // Устанавливаем радиусы для верхних углов
        overflow: "hidden" // Обрезаем контент, чтобы он соответствовал радиусам
      }
    }}>
      <Swiper
        spaceBetween={10}
